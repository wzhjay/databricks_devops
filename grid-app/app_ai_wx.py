...
Weather forecast context may be included. When present, include a brief summary of expected weather conditions and consider weather impacts only when relevant to operational risk, maintenance planning, site reliability, or demand/load behavior. Do not overstate certainty or speculate beyond the provided forecast.

JSON payload:
{json.dumps(details, default=str, indent=2)}
"""
    weather_context = get_weather_context(details["site"])
